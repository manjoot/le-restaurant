...
const Header = () => {
	...
	return (
		...
		<header className="w-full flex h-20 items-center border-b bg-white shadow-md px-6 md:px-10 xl:px-14 space-x-12">
			<span className="flex-1">
				<Link href="/">
					<img src="https://i.ibb.co/G9HBzxV/restaurant.png"className="h-12 w-16 hover:cursor-pointer" ></img>
